...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectimg = findViewById(R.id.upload_imagebtnUI);
        imageView = findViewById(R.id.uploadedimg_UI);
        Compid = findViewById(R.id.CompID_CR);
        textViewpn = findViewById(R.id.textViewpn);
        progressbar_tb = findViewById(R.id.progressbar_tb);

        UploadBtn = findViewById(R.id.participatedada_btnUI);
        ...
        UploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(imageuri != null){
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            fileref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    String Did = getIntent().getStringExtra("OrdId");
                                    databaseReference.child(getIntent().getStringExtra("OrdId")).child("comp_ImageUrl").setValue(Comp_ImageUrl);
                    ...
                    Toast.makeText(UploadImage.this, "Image not selected!!", Toast.LENGTH_SHORT).show();
                    textViewpn.setVisibility(View.VISIBLE);
                    progressbar_tb.setVisibility(View.INVISIBLE);
                }
            }
