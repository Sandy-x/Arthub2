...
public class photographylistModel {
    ...
    public photographylistModel() {
    }

    public photographylistModel(String entry_fee, String last_date, String image_url, String topic, String firstPrize, String secondPrize, String thirdPrize, String compid) {
        Entry_fee = entry_fee;
        Last_date = last_date;
        Image_url = image_url;
        Topic = topic;
