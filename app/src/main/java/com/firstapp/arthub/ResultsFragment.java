...
public class ResultsFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Compid = view.findViewById(R.id.CompID_CR);
        String uid = FirebaseAuth.getInstance().getCurrentUser().getUid();
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Results").child("Drawing").child(uid);
        firstp = view.findViewById(R.id.FirstWinnerCR);
        secondp = view.findViewById(R.id.SecondWinnerCR);
        linearresultFR = view.findViewById(R.id.linearresultFR);
        showwinnersbtn = view.findViewById(R.id.showwinnersBTN);
        thirdp = view.findViewById(R.id.ThirdWinnerCR);
