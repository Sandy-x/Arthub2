...
public class DetailActivity_painting extends AppCompatActivity implements PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image = findViewById(R.id.imagepassfrom_recycledap);
        fee = findViewById(R.id.entryfeedrawing_recycledap);
        lastdate = findViewById(R.id.lastdatedrawing_recycledap);
        topic = findViewById(R.id.topicdrawing_recycledap);
        partipate = findViewById(R.id.participatedap_btn);
        upimage = findViewById(R.id.uploadedimg_dap);
        email = findViewById(R.id.email_dap);
        name = findViewById(R.id.fullname_dap);
        progressDialog = new ProgressDialog(DetailActivity_painting.this);
        uploadimagebtn = findViewById(R.id.upload_imagebtndap);
        dialog = new Dialog(DetailActivity_painting.this);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Intent in = new Intent(DetailActivity_painting.this,MainActivity.class);
        ...
        uploadimagebtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImagePicker.Companion.with(DetailActivity_painting.this)
                        .crop()
        ...
        //drawing
        Intent i = getIntent();
        String imageep = i.getStringExtra("imagep");
        Picasso.get().load(imageep).into(image);
        fee.setText(getIntent().getStringExtra("feep"));
        topic.setText(getIntent().getStringExtra("topicp"));
        lastdate.setText(getIntent().getStringExtra("last_datep"));
    ...
    private void saveorder() {
        ...
        String Poster_url = getIntent().getStringExtra("imagep");
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    fileref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            All_user_competetionlists user = new All_user_competetionlists( Cat,CompId,Email, Name,Fees,LastDate,Category,PaymentStatus,Topic,Poster_url,Comp_ImageUrl,RegisteredDate);
                            databaseReference1.child("Painting").child(uid).push().setValue(user);
                            databaseReference2.child(uid).push().setValue(user);
                            databaseReference3.child("Painting").child(uid).push().setValue(user);
                            dialog.show();
